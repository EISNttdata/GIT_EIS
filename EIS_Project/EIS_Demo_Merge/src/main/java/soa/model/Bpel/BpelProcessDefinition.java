...
public class BpelProcessDefinition {
    ...
    //Added @Manoj to handle various namespaces
    private static List<QName> namespaces=new ArrayList<>();

    private List<VariableDefinition> variables = new ArrayList<VariableDefinition>();
    private static List<ImportDefinition> imports = new ArrayList<ImportDefinition>();
    public static List<SequenceDefinition> sequences = new ArrayList<SequenceDefinition>();
